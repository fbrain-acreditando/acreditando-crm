// OpenAPI 3.1.2 "source of truth" for Acreditando CRM Public API (Integrations).
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'Acreditando CRM Public API',
      version: 'v1',
      description:
        'API pública do Acreditando CRM para integrações (n8n/Make). Produto em primeiro lugar: copiar → colar → testar.',
    },
